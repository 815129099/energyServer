...
public class HexUtil {
    ...
    public static String bytesToHexFun4(byte bytes) {
        StringBuilder buf = new StringBuilder( 2);

            buf.append(String.format("%02x", new Integer(bytes & 0xff)));
    ...
    public static void main(String[] args) throws Exception {
        byte[] bytes =HexUtil.toBytes("008007B2");
...
/*
        ...
        String str = "00 00 00 00 00 06 07 03 0C 84 00 04";
        byte[] bytes = toBytes("00000000000607030C840004");
